...
class MenuSeeder extends Seeder
{
    ...
    private function assignAdditionalPhotos(): void
    {
        $assignments = [
            ...
            ['name' => 'BEEF KECOMBRANG FRIED RICE', 'image' => '/images/menu/hero/aab_menu-1.jpg'],
            ['name' => 'PEPPERONI', 'category' => 'Pizza', 'image' => '/images/menu/hero/aab_menu-2.jpg'],
            ['name' => 'CREAMY CHICKEN PESTO PASTA', 'image' => '/images/menu/hero/aab_menu-3.jpg'],
            ['name' => 'PANNACOTTA', 'image' => '/images/menu/hero/aab_menu-6.jpg'],
